 ...
 *
 */
public class Controler_InterfacePrincEleve implements ActionListener {

    private MainWindow window;
    private String button;

    public Controler_InterfacePrincEleve(MainWindow w, String b) {
        button = b;
        window = w;
    }
    ...
    public void actionPerformed(ActionEvent a) {
        ...
        switch (button) {
            case "RESULTATS": //on atterit sur l'interface résultats
                window.refreshW(window.getResults().getInterfaceResultat());
                break;
            case "SAUVEGARDE": //on enregistre la tentative de l'élève
                break;
            case "REVOIR": //les étapes que l'élève vient de faire sont rejouées sur l'écran
                break;
